 ...
 */
public class QbParser_TestMultiplyingOutput {
    ...
    public QbParser_TestMultiplyingOutput(String typeProperty) {
    ...
    private void getShapesInfoAndComputeSupport() {
        ...
        for (Integer classIri : this.classes) {
            ...
            for (String property : props) {
                ...
                if(queryToVerifyLiteralObjectType.contains("version"))
                    System.out.println();
                //Literal Type Object
                if (graphDBUtils.runAskQuery(queryToVerifyLiteralObjectType)) {
                    ...
                    if(queryToVerifyLiteralObjectType.contains("http://dbpedia.org/property/parents") && queryToGetDataTypeOfLiteralObject.contains("http://www.w3.org/2002/07/owl#Thing"))
                        System.out.println();
                    if (results != null) {
                        results.forEach(row -> {
