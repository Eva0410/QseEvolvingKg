...
public class RQ2ComparisonTests {
    ...
    public void peopleTest() {
        ...
        String filePath = RQ2UnitTests.generateFile(content);
        String addedPath = RQ2UnitTests.generateFile(contentAdded);
        String deletedPath = RQ2UnitTests.generateFile(contentDeleted);
        String newPath = RQ2UnitTests.generateFile(contentNew);
